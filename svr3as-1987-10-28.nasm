...
section .xtext
  ...
  incbin_until 0x3f01a4
    ...
    jmp strict short jmp_to_flagcont
    fill_until 0x3f01c0
  incbin_until 0x3f0450
    main:
    incbin_until 0x3f045b
    fatal_usage:
  ...
  incbin_until 0x3f78b0
    ...
    li3_syscall  ; Doesn't return.
    fill_until 0x3f78ec
  incbin_until 0x3f7990
    errmsg:
    incbin_until 0x3f799e
    mov eax, cfile
    mov ecx, [filenames_0]
    test ecx, ecx
    ...
    fill_until 0x3f79be, nop  ; About 10 bytes, until the push aAssemblerS.
    .push:
  ru 0x3f9d54
...
section .xdata
  ...
  r 0x40b662, 0x40b696
  r 0x40b8ae, 0x40b8fe
  incbin_until 0x40b977
    fill_until 0x40b980  ; Gap previously used by tempnam_hardcoded_tmp.
