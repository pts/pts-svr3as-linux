...
for f in "$@"; do  # Import each specified file.
  ...
  if test "$hash" = "5577d763edd9b0a80174ac229f76da602ef77abe5007df98b5b372e4c85f1c10  -";  then   # sds1.img
    ...
    test "$(sha256sum <import.tmp/svr3as-1988-05-27.svr3)" = "ab7048e14136b142c0264d4f13e9771a05c489661acab562b37929931c0f4c04  -"
    cmp import.tmp/svr3as-1988-05-27.svr3 svr3as-1988-05-27.svr3 2>/dev/null || cp -ai import.tmp/svr3as-1988-05-27.svr3 svr3as-1988-05-27.svr3
    #
    rm -f import.tmp/f.bin
    ln -s "$ff" import.tmp/f.bin
    ...
    test "$(sha256sum <import.tmp/svr3ld-1988-05-27.svr3)" = "9205364de3df93659ede3ac8d2dabe76151c860090af9b5a71f9ff0edef64d16  -"
